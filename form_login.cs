...
namespace QL_CAFE
{
    public partial class form_login : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-0LKMS10\SQLEXPRESS01;Initial Catalog=SQL_QLCafe;Integrated Security=True");
            ...
            try
            {
                ...
                string sql = "Select TenDN,MatKhau from NHANVIEN WHERE TenDN ='" + tk + "' and MatKhau = '" + mk + "'";
